# AIRo Control Interface (with Disturbance Observer)
This repository contains the implementation for this preprint:

Cheung, H., et al. "Aerial Grasping with Soft Aerial Vehicle Using Disturbance Observer-Based Model Predictive Control," in arXiv preprint arXiv:2409.14115, 2024. [paper](https://arxiv.org/abs/2409.14115) | [video](https://youtu.be/vA5KXU8RiZw?si=-n1TSEDHZXzRIOGN)
...
```
## EKF Disturbance Observer
You can edit the header file [here](https://github.com/HKPolyU-UAV/airo_control_interface/blob/observer_class/airo_control/include/airo_control/observer/ekf_observer.h).

You can also modify the EKF observer [here](https://github.com/HKPolyU-UAV/airo_control_interface/blob/observer_class/airo_control/src/observer/ekf_observer.cpp).
