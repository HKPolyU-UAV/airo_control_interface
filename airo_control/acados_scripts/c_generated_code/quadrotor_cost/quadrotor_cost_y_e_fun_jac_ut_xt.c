...
/* quadrotor_cost_y_e_fun_jac_ut_xt:(i0[8],i1[],i2[],i3[4])->(o0[8],o1[8x8,8nz],o2[8x0]) */
...
CASADI_SYMBOL_EXPORT casadi_int quadrotor_cost_y_e_fun_jac_ut_xt_n_in(void) { return 4;}
